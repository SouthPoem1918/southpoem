...
<div class="page-container">
    ...
    <a href="javascript:;" onclick="admin_permission_add('添加权限节点','/admin/auth/add','','390')" class="btn btn-primary radius">
    <i class="Hui-iconfont">&#xe600;</i> 添加权限节点</a></span> <span class="r">共有数据：
	...
	<table class="table table-border table-bordered table-bg" id="tb">
		<thead>
			...
			<tr class="text-c">
				...
				<th width="100">方法名</th>
				<th width="100">父级权限</th>
				<th width="100">作为导航</th>
				<th width="100">操作</th>
			</tr>
		</thead>
		<tbody>
