...
<div class="page-container">
    ...
    <i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
     <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加角色','/admin/role/add','800')">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$value->auth_ids}}</td>
				<td>{{$value->auth_ac}}</td>
				<td class="f-14">
                    <a title="权限分派" href="javascript:;" onclick="admin_role_assign('权限分派','/admin/role/assign','{{$value->id}}')" style="text-decoration:none"><i class="Hui-iconfont">&#xe681;</i></a>
                    <a title="编辑" href="javascript:;" onclick="admin_role_edit('角色编辑','admin-role-edit.html','1')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
